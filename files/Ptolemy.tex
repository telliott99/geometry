...
Our Ptolemy is known for many works including his book the \emph{Almagest}, and important to us here, for a theorem in plane geometry concerning cyclic quadrilaterals.  These are 4-sided polygons all of whose vertices lie on a circle.  
...
Together, opposing angles exactly correspond to the whole arc of the circle.

$\square$

Draw the diagonals $AC$ and $BD$.  Ptolemy's theorem says that if we take the products of the two pairs of opposing sides and add them, the result is equal to the product of the diagonals.
...
The proof begins by noting the angles in the figure.  By the inscribed angle theorem, equal angles lying on the circle sweep out equal arcs and also chords.  This gives four pairs of equal angles, as marked by the colored dots.
...
The reason is that opposing corners of the original figure together contain a complete complement of angles.  This is fairly obvious from the first proof in this chapter, since the opposing vertices in a cyclic quadrilateral must correspond to the whole arc of the circle.  Here, we add more detail, with red and magenta on the left plus black and green on the right.
