...
By definition, the central angle sweeping out a given arc is equal in measure to the length of the arc.  We have shown that the peripheral angle subtended by the same arc is one-half the central angle so  $2 \phi = \theta$.  We will not repeat the proof here but just show the figure to remind us.
