...
I struggled to find a good proof of this lemma.  The closest I got is Euclid I.7 to show that $c \ne d$.  This proof using the law of cosines seems like overkill, but it does work, and quickly.  I would like to find something more fundamental.
...
\emph{Proof}. Let $\triangle ABC$ have the base angles $B$ and $C$ with $B < C$ and each angle bisected, by $BM$ and $CN$.  
...
(This would be the converse to Euclid III.26).
