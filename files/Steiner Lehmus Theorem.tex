...
\[ d^2 - c^2 = \cos \theta - \cos \phi \]

$d > c \Rightarrow \cos \phi < \cos \theta \Rightarrow \phi > \theta$.  Similarly, $\phi > \theta \Rightarrow d > c$  $\square$
...
For more about SSA and the importance of the additional information about the angle, see \hyperref[sec:use_of_SSA]{\textbf{here}}.
...
One more proof (reprinted in Coxeter) can be found here:
