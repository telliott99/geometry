...
Heron's formula was later found to be a special case of a similar formula for quadrilaterals, discovered by Brahmagupta, which we'll study later.

The treatment in this chapter does not depend on trigonometry (at least overtly).
...
In comparing the two proofs, it's clear that the latter proof draws on the ideas of (i) using the semi-perimeter and (ii) difference of squares, which are in Heron's proof.  The main new ideas are trigonometric:  the law of cosines and the cancelation of $\sin^2 x + \cos^2 x$.
