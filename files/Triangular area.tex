...
However, this book is about Euclidean geometry.  Let's just say a few words about rectalinear area, which we will then extend to the areas of triangles and parallelograms, which are like  squashed rectangles.
...
Suppose, instead that the squares had side lengths of $2.54$ cm.  Then, define $1$ in $= 2.54$ cm.  The total area would be $48$ in$^2$.
...
Suppose we are given, at first, only that $AD \parallel BC$.  Then the angles marked with black dots are equal, by the alternate interior angles theorem.  
...
If the parallelogram is particularly skinny for a given height (how skinny?), then it will not be possible to cut off just one triangle.  Euclid spends some time working through this issue to prove that the area of any parallelogram is the base times the "height".
...
\[ \frac{A_A}{A_B} = \frac{ah}{bh} = \frac{a}{b} \]
