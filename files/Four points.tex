...
Special points in triangles include the following four famous examples.  When referring to the central point, we would call them:  incenter, circumcenter, orthocenter and centroid.
...
By definition, the tangent is perpendicular to the radius where it touches the circle.  So $\triangle AOF \cong \triangle AOE$ by SSA in a right triangle.  
