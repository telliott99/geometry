...
No matter how the measurement is to be performed, we \emph{define} the measure of an angle $s$ to be equal to the arc $a$ it sweeps out, or subtends, in a circle of radius $1$, a \emph{unit} circle.  Angles are not lengths, but numerically, the measure of the angle is the measure of the arc.
