...
The forward theorem is that if two sides in a triangle are equal, then so are the opposing angles.  It's difficult precisely because Euclid proves it \emph{before} we know how to bisect an angle.
