...
This (Euclid I.4) is a proof that SAS is correct.
...
Since $\angle ADC = \angle AEB$ and the flanking sides are equal, namely, $AD = AE$ and $CD = BE$, we have $\triangle BCD \cong \triangle CBE$ by SAS.

But now, $\angle DBC = \angle ECB$.

By supplementary angles, $\angle ABC = \angle ACB$.
...
\begin{center} \includegraphics [scale=0.3] {Euclid_I_6.png} \end{center}

\emph{Proof}.

Given $\angle ABC = \angle ACB$.  Suppose $AB \ne AC$.  Then let one be less, say $AC$.  So cut off from $AB$ the length $BD = AC$.

Compare $\triangle ABC$ with $\triangle DBC$.  We have the sides equal, namely $BD = AC = AB$.  We have $BC$ and $\angle DBC$ shared.  Therefore $\triangle ABC \cong \triangle DBC$ by Euclid I.4 (SAS).
