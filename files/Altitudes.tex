...
Each of the three sides of a triangle has an altitude.
...
For an obtuse triangle, two of the altitudes are external to the triangle, and the third altitude must be extended externally, past the vertex, to meet the other two at the orthocenter.
...
You recall the formula:  one-half base times height.  Often I find it easier to dispense with the factor of one-half, and to do that, I will calculate twice the area.

In the figure above, twice the area is 
...
\begin{center} \includegraphics [scale=0.4] {area8b.png} \end{center}
...
There are six small triangles.  To make it easier to keep track of them, they are labeled with colored dots (note:  for this time only, these are labels not for angles, but for triangles).
