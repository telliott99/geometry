...
\emph{Proof}.  (Sketch).  Look ahead to the \hyperref[sec:hinge_theorem]{\textbf{hinge theorem}}, Euclid I.24.  In two triangles greater angle lies opposite the greater third side.  Thus, the greater chord lies in the greater circumference because they are connected through the angle.  $\square$
