...
There is one other important case we will need when we discuss the proofs about similar triangles:
...
Pappus came up with a beautiful theorem, which includes the Pythagorean theorem as an extensions.  First, we need a simple lemma about parallelograms.
