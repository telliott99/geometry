...
Start with Simmons.  He summarizes Algebra, Geometry, Analytic Geometry and Trigonometry in a little more than one hundred pages.  The book can easily be found used, and I highly recommend it.  After that, try Jacobs, or Kiselev.  

One other resource that I enthusiastically recommend is a website with a highly annotated version of Euclid's \emph{Elements}.
...
Another really great resource is an old textbook by Hopkins that I found online:
...
Here is are two examples from Dartmouth, 1900:
