...
We first establish a preliminary result, which is called \hyperref[sec:Menelaus_theorem]{\textbf{Menelaus's theorem}}, due to Menelaus of Alexandria (the geometer, not the mythological figure). 
...
There is a story that Einstein disliked the proof of Menelaus's theorem given above.
