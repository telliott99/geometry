...
Consider $\triangle ABC$ and a line that goes through the triangle (not through a vertex), called a transversal.  There is one side, which when it is extended, meets the transversal.  Here the transversal $PQR$ meets $BC$ at $R$.
...
He said they were ugly, and didn't involve the vertices symmetrically.  I read that Einstein's proof starts by dropping altitudes to the traversal, and then uses similar triangles.  Here's what I came up with.
