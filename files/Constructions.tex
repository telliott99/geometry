...
$\circ$ \ As radii of two congruent circles, we have four equal line segments:  $QS = SR = RT = QT$.

$\circ$ \ Thus the tall triangles on the vertical midline are congruent $\triangle QST \cong \triangle SRT$ by SSS (two sides equal and one shared).  Similarly the squat triangles on the horizontal midline are also congruent:  $\triangle QRS \cong \triangle QRT$.

$\circ$ \ Therefore the two angles at $S$, $\angle QSP$ and $\angle PSR$, are equal. 
 
$\circ$ \ Therefore $\triangle QPS \cong \triangle PRS$ by SAS.  

$\circ$ \ $\triangle QPT \cong \triangle PRT$, for the same reason.
...
$\circ$ \ Hence, $QP = PR$ by congruent $\triangle$.  And $SP = PT$ for the same reason.

$\circ$ \ $\angle QPS = \angle SPR$ by congruent $\triangle$, so both are right angles.

$\circ$ \ Therefore all the angles at $P$ are right angles and all four small right triangles are congruent.
