...
\begin{center} \includegraphics [scale=0.5] {arcs8b.png} \end{center}

\emph{Proof}.

\[ \angle ROQ = \pi - 2(u + s) \]

By the sum of angles theorem, in the triangle with two red sides, $\pi = t + (t + s) + (u + s) + u$.  Substituting for $\pi$ above:

\[ \angle ROQ =  t + (t + s) + (u + s) + u- 2(u + s) \]
\[  = 2t \]
but $t$ is the measure of $\angle QPR$.
