...
The height of these triangles, all the same, is called its apothem.  We calculate both the height and the base for specific examples elsewhere.  Our point here is that if the polygon has $n$ sides, then the total area is \emph{approximately}
