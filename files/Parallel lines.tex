...
This is first of all a statement about the world, that we can have two lines that run alongside each other but don't touch.  Then, by symmetry, since we have no reason to distinguish them in the forward and reverse directions, the angle between each one and a third line is the same for both.  And this reasoning works, as long as we are talking about lines on a piece of paper.
