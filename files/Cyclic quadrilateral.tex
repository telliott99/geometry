...
By looking at subtended arcs, we can get relationships for the new angles in $\triangle BCG$, and by similar triangles we can get the others shown:
...
$\angle AMC$ and $\angle AMB$ are both peripheral and both subtend the same arc as an angle of $\triangle ABC$, hence we place two more red dots (middle).
...
Therefore, the non-overlapping parts are also equal (marked with blue dots).  We place two magenta dots at angles that subtend arc $MC$.
